...
public final class CrigttXmlNs {
    ...
    public final static String VALIDATE_PREFIX = "validate";
    ...
    public final static String STATIC_VOCAB_URI = "http://www.lantanagroup.com/voc";
    public final static String VALIDATE_URI = "urn:gov.hhs.onc.crigtt:validate";
